...
// must import store to NewStudentForm

import { useStudentStore } from "../stores/StudentStore.js";

// need to create student store for this component
const studentStore = useStudentStore()
// newStudentForm could potentially read data from the StudentStore but we won't set that up
...
const addStudent = () => {
  ...
  if (formErrors.value.length == 0) {
    ...
    // add student inside pinia store
